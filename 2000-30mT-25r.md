...
```python
#System object
system = oc.System(name="paper-t25")
...
def Ms_function2 (pos):
    ...
    p3 = list(range(25,2000,100))
    p4 = [i * 1e-9 for i in p3]
    p5 = list(it.product(p4,p4,[0]))
    for pt in p5:
        if hdistance(pos,pt) <= 25e-9:
            return 8e5
    else:
            return 0
```
...
```
    ...
    2018/09/27 18:54: Running OOMMF (paper-t25\paper-t25.mif) ... (20.1 s)
...
```
    ...
    2018/09/27 18:54: Running OOMMF (paper-t25\paper-t25.mif) ... (1310.7 s)
